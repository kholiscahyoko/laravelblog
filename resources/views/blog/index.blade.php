...
@if (Auth::check())
    <div class="pt-15 w-4/5 m-auto">
        <a href="/blog/create" class="bg-blue-500 uppercase bg-transparent text-gray-100 text-sm font-extrabold py-3 px-5 rounded-3xl">Create Post</a>
    </div>
@endif
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        ...
        <div>
            ...
            <span class="text-gray-500">
                By <span class="font-bold italic font-gray-800">{{ $post->user->name }}</span>, Created on {{ date('jS M Y', strtotime($post->updated_at)) }}
            </span>
